#' @title IPF Single Cell Altas data
#'
#' @description The lung data is a subset of patient "001C" profiled in IPF
...
#' {https://www.biorxiv.org/content/10.1101/759902v1.full.pdf}
